...
## Figure 3: Selected Sphagnum species: Medium and Fuscum
...
```{r}
figure3_b<-ggarrange(figure3_b_1,figure3_b_2,figure3_b_3,nrow=1)
figure3_c<-ggarrange(figure3_c_1,figure3_c_2,nrow=1)
figure3_d<-ggarrange(figure3_d_1,figure3_d_2,nrow=1)
```
...
## Figure 4: Selected Sphagnum species: Rubellum and Balticum
...
```{r}
figure4_a<-ggarrange(figure4_a_1,figure4_a_2,figure3_b_3,nrow=1)
...
figure4<-plot_grid(
  plot_grid(figure4_a,figure4_b,ncol=2,labels=c("A)","B)"),
            label_fontfamily="serif",rel_widths=c(0.7,0.3))+
    theme(plot.background=element_rect(fill="white", color = NA)),
